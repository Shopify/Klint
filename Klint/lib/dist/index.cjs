...
function useAnimate(contextRef, draw, isVisible) {
  const animationFrameId = (0, import_react.useRef)();
...
// src/plugins/BitmapText.tsx
var BitmapText = class {
  constructor(ctx) {
    ...
    this.createFontTexture = async (chars, size) => {
...
var BitmapText_default = BitmapText;
